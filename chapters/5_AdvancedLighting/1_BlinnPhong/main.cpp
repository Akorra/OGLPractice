...
int main()
{
    ...
    Shader shader("./shaders/advancedlighting/1/lights.vs.glsl", "./shaders/advancedlighting/1/lights.fs.glsl");
    ...
    uint32_t tex = loadTexture("./resources/textures/wood.png", true);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.setVec3("lightPos", glm::vec3(8.0f*glm::sin(0.5f*tm), 0.0f, 8.0f*glm::cos(0.5f*tm)));
...
void processInput(GLFWwindow *window)
{
    ...
    if (!bPressed && glfwGetKey(window, GLFW_KEY_B) == GLFW_PRESS)
    {
        bPressed = true;
        blinn = !blinn;
    }
    if(bPressed && glfwGetKey(window, GLFW_KEY_B) == GLFW_RELEASE)
    {
        bPressed = false;
    }
}
