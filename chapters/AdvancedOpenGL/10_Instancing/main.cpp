...
int main()
{
    ...
    Shader shader("./shaders/advancedogl/10/base.vs.glsl", "./shaders/advancedogl/10/base.fs.glsl");
    ...
    // passing instance data as vertex attribute:
    /*
    glm::vec2 translations[100]; //< fill this first
