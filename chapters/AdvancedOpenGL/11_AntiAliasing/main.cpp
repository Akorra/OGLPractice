...
int main()
{
    ...
    Shader shader("./shaders/advancedogl/11/anti_aliasing.vs.glsl", "./shaders/advancedogl/11/anti_aliasing.fs.glsl");
    Shader screenShader("./shaders/advancedogl/11/aa_post.vs.glsl", "./shaders/advancedogl/11/aa_post.fs.glsl");
    ...
    uint32_t textureColorBufferMultiSampled;
